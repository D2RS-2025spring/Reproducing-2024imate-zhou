#Figure-3A
library(ggplot2)  
fit<- read_excel("C:/Users/罗七七/Desktop/Figure 3/Origin Data/Figure3-A.xlsx",1)
names(fit)
...
df <- read_excel("C:/Users/罗七七/Desktop/Figure 3/Origin Data/Figure3-B1.xlsx",1)
names(df)
...
####
df <- read_excel("C:/Users/罗七七/Desktop/Figure 3/Origin Data/Figure3-B2.xlsx",1)
names(df)
...
####
df <- read_excel("C:/Users/罗七七/Desktop/Figure 3/Origin Data/Figure3-B3.xlsx",1)
names(df)
...
data <- read_excel("C:/Users/罗七七/Desktop/Figure 3/Origin Data/Figure3-C.xlsx",1)
names(data)  
Vec1 <- c("aCO2", "eCO2")  
